 ...
 */
 ...
 /* OK, thats the explaination given by Dmitry 
  * Here's how i implemented it  :
  * downloaded all neccesary libs 
  * add them to this folder 
  * updated the proprietary-files.txt(by removing some lib names)
  * Add all libs 
  * Updated the proprietary files with the libs (libs which still have name in proprietary-files.txt)
  * So if anyone of them is used we could still get the desired output
  */
